...
import ayush from '../public/profile.jpg';
import web7 from "../public/web7.jpg";
import web9 from "../public/web8.png";
            ...
            <div className="basis-1/3 flex-1 relative">
              <div className="group">
                ...
                <div className="absolute bottom-0 left-0 right-0 top-2/3 bg-black bg-opacity-50 text-white p-4 transition-opacity duration-300 opacity-0 group-hover:opacity-100">
                  ...
                  <p className="text-2xl text-gray-200 font-burtons mayer">
                    Developed a full-stack job portal using MERN stack with role-based access, where recruiters can post and manage jobs while candidates can browse, apply, and track applications. Implemented secure user authentication and application management features.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="basis-1/3 flex-1 relative">
              <div className="group">
                ...
                <div className="absolute bottom-0 left-0 right-0 top-2/3 bg-black bg-opacity-50 text-white p-4 transition-opacity duration-300 opacity-0 group-hover:opacity-100">
                  ...
                  <p className="text-2xl text-gray-200 font-burtons mayer">
                    AI-based tool that reviews your code, identifies errors, suggests optimized solutions using Gemini, and provides a step-by-step dry run to help you understand how it works.
                  </p>
                </div>
              </div>
            </div>
